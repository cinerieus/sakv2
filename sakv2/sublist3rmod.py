...
def parse_args():
    ...
    optional.parser.add_argument('-o', '--output', help='Save the results to text file', default="")
...
def main(domain, threads, savefile, ports, silent, verbose, enable_bruteforce, engines):
    try:
        ...
        if enable_bruteforce:
            ...
            output = False
            json_output = False
            bruteforce_list = subbrutemod.print_target(parsed_domain.netloc, record_type, subs, resolvers, process_count, output, json_output, search_list, verbose)
